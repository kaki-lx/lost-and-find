<template>
    ...
    <div class="container">
        <div class="ONE">
            <div class="left">
                <p><span class="link" @click="toIndex">首页</span> > 信息管理 > 用户信息管理</p>
            </div>
            <div class="right">
        ...
        <div class="TWO">
            <el-table :data="viewList" border highlight-current-row style="width: 100%; text-algin: center;">
                ...
                <el-table-column prop="createDate" label="注册日期" width="200" sortable header-align="center"
                    align="center">
                ...
                <el-table-column prop="phone" label="联系电话" width="120" header-align="center" align="center">
                </el-table-column>

                <el-table-column prop="identity" label="身份" width="120" header-align="center"
                ...
                <el-table-column label="操作" width="220" header-align="center" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button size="mini" type="danger" :disabled="scope.row.id === userInfo.id"
        ...
        <el-dialog class="view-dialog" title="用户信息" :visible.sync="viewDialogVisible" width="40%" top="80px">
            <div class="dialog-container">
                <div class="left">
                    <el-avatar v-if="view.user_pic" :size="120"
                        :src="require('../../../public/user_pic/' + view.user_pic)"
                        style="margin-right: 10px; border: solid 1px black;"></el-avatar>
                    <el-avatar v-if="!view.user_pic" :size="120" :src="require('../../../public/no_pic/noAvatar.png')"
                        style="margin-right: 10px; border: solid 1px black;"></el-avatar>
                </div>
        ...
        <el-dialog class="edit-dialog" title="用户信息" :visible.sync="editDialogVisible" width="50%" top="40px">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-row :gutter="20">
                    <el-col :span="24" style="text-align: center;">
                        <div class="avatar" @click="changeAvatar">
                            <el-avatar v-if="form.user_pic" :size="80"
                                :src="require('../../../public/user_pic/' + form.user_pic)"
                                @click="changeAvatar"></el-avatar>
                            <el-avatar v-if="!form.user_pic" :size="80"
                                :src="require('../../../public/no_pic/noAvatar.png')" @click="changeAvatar"></el-avatar>
                        </div>
                    </el-col>
                </el-row>
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        ...
                        <el-form-item label="账号" prop="username" :label-width="formLabelWidth">
                            <el-input v-model.trim="form.username" placeholder="请输入账号" type="text" maxlength="12"
                                show-word-limit></el-input>
                        </el-form-item>

                        <el-form-item label="年龄" prop="age" :label-width="formLabelWidth">
                            <el-input type="text" placeholder="请输入年龄" oninput="value=value.replace(/[^\d]/g, '')"
                        ...
                        <el-form-item label="联系方式" prop="phone" :label-width="formLabelWidth">
                            <el-input v-model.trim="form.phone" placeholder="请输入联系方式" type="text" maxlength="11"
                                show-word-limit></el-input>
                        </el-form-item>
                    </el-col>
                    <!-- 第二列 -->
                    <el-col :span="12">
                        <el-form-item label="注册时间" prop="createDate" :label-width="formLabelWidth">{{ form.createDate
                            }}</el-form-item>

                        <el-form-item label="头像" prop="user_pic" :label-width="formLabelWidth">{{ form.user_pic ?
                            form.user_pic :
                            '默认头像' }}</el-form-item>

                        <el-form-item label="昵称" prop="nickname" :label-width="formLabelWidth">
                            <el-input v-model.trim="form.nickname" placeholder="请输入昵称" type="text" maxlength="8"
                                show-word-limit></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="密码" prop="password" :label-width="formLabelWidth">
                            <el-input v-model.trim="form.password" placeholder="请输入密码" type="text" maxlength="12"
        ...
        <el-dialog class="avatar-dialog" title="修改头像" :visible.sync="avatarDialogVisible" width="30%"
