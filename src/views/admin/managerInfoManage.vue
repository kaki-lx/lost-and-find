<template>
    ...
    <div class="container">
        ...
        <el-dialog class="view-dialog" title="用户信息" :visible.sync="dialogVisible" width="40%" top="80px">
            <div class="dialog-container">
                ...
                <div class="right">
                    <el-descriptions title="" border :column="1" :labelStyle="{ 'width': '40%', 'text-align': 'center' }"
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="注册时间" prop="createDate"
                            :label-width="formLabelWidth">{{ form.createDate }}</el-form-item>
